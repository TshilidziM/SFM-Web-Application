<%@ Page Title="" Language="C#" MasterPageFile="~/SFM_Master.Master" AutoEventWireup="true" CodeBehind="Manager_AssignedAccount.aspx.cs" Inherits="SFM_Consulting_Beta.Manager_AssignedAccount" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="page-head-line">  <i class="fa fa-briefcase fa-2x"></i>&nbsp; Assigned Accounts </h2>
