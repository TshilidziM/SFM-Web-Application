<%@ Page Title="" Language="C#" MasterPageFile="~/SFMConsulting.Master" AutoEventWireup="true" CodeBehind="SFM_BusinessConsulting.aspx.cs" Inherits="SFM.SFM_BusinessConsulting" %>
...
<asp:Content ID="BusinessConsultingPage" ContentPlaceHolderID="ContentPlaceHolder" runat="server">

     <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                    <h1 class="page-head-line">  <i class="fa  fa-group fa-5x"></i>Business Consulting</h1>
                    </div>
                </div>
