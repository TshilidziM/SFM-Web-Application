<%@ Page Title="" Language="C#" MasterPageFile="~/SFMConsulting.Master" AutoEventWireup="true" CodeBehind="SFM_Registration.aspx.cs" Inherits="SFM.SFM_Registration" UnobtrusiveValidationMode="None" %>
...
<asp:Content ID="RegistrationPage" ContentPlaceHolderID="ContentPlaceHolder" runat="server">

    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
               <h1 class="page-head-line">  <i class="fa  fa-pencil-square-o fa-5x"></i>Complete To Register</h1>
