<%@ Page Title="" Language="C#" MasterPageFile="~/SFMConsulting.Master" AutoEventWireup="true" CodeBehind="Manager_Dashboard.aspx.cs" Inherits="SFM.Manager_Dashboard" %>
            ...
            <div class="row">
                 <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-one">
                        <a href="Manager_AssignedAccount.aspx"><i  class="fa fa-briefcase dashboard-div-icon" ></i> </a>
  ...
  <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 80%">
                 ...
                 <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-two">
                         <a href="Manager_AssignWork.aspx"><i  class="fa fa-clipboard dashboard-div-icon"></i></a>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%">
                 ...
                 <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-three">
                         <a href="Manager_OverallProgress.aspx"><i  class="fa fa-pie-chart dashboard-div-icon" ></i></a>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-four">
                         <a href="Manager_AccountProgress.aspx"><i  class="fa fa-clock-o dashboard-div-icon" ></i></a>
                        <div class="progress progress-striped active">
  <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
  </div>
                           
</div>
                         <h5> Account Progress </h5>
                    </div>
                </div>
             ...
             <div class="row">
                 <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-one">
                         <a href="Manager_AssignedAccount.aspx"><i  class="fa fa-bar-chart-o dashboard-div-icon" ></i></a>
                        <div class="progress progress-striped active">
