<%@ Page Title="" Language="C#" MasterPageFile="~/SFMConsulting.Master" AutoEventWireup="true" CodeBehind="SFM_TaxConsulting.aspx.cs" Inherits="SFM.SFM_TaxConsulting" %>
...
<asp:Content ID="TaxConsultingPage" ContentPlaceHolderID="ContentPlaceHolder" runat="server">

     <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                       <h1 class="page-head-line">  <i class="fa fa-superscript fa-5x"></i>Tax Consulting</h1>
                    </div>
                </div>
  ...
  <div class="form-group">
    ...
    <input type="file" id="ProofOfPayment" > <input/>
                    ...
                    <hr/>
                            <a href="Client_Dashboard.aspx"><label class="btn btn-go"><i class="fa fa-upload"></i> Upload </label ></a>
